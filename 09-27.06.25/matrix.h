 ...
 *             MatrixNo: Nr. der Matrix, fuer die nach der Zeilenanzahl gefragt
 *wird Ergebnis : Gibt die Anzahl der Matrixzeilen zurueck (ist garantiert eine
 *Zahl zwischen 1 und MaxRows!)
 ***************************************************************************/
 ...
 *  Parameter: Row, Col: Zeile und Spalte, in der die Benutzerfrage beginnt
 *             MatrixNo: Nr. der Matrix, fuer die nach der Spaltenanzahl gefragt
 *wird Ergebnis : Gibt die Anzahl der Matrixspalten zurueck (ist garantiert eine
 *Zahl zwischen 1 und MaxColumns!)
 ***************************************************************************/
 ...
 *  Parameter: Row, Col: Zeile und Spalte, in der die Matrix auf dem Bildschirm
 *beginnt RowCount, ColCount: Zeilen- und Spaltenanzahl der genutzten Matrix
